    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    <form method="POST" action="{{ route('admin.affiliate-sites.update', $affiliateSite) }}" id="affiliate-site-form">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="mb-6">
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" name="name" id="name" value="{{ old('name', $affiliateSite->name) }}"
                            ...
                            <div class="mb-4">
                                ...
                                <input type="url" name="base_url" id="base_url" value="{{ old('base_url', $affiliateSite->base_url) }}" placeholder="https://example.com"
                            ...
                            <div class="mb-4">
                                <label class="flex items-center">
                                    <input type="checkbox" name="is_enabled" value="1" {{ old('is_enabled', $affiliateSite->is_enabled) ? 'checked' : '' }}
                        ...
                        <div class="mb-6">
                            ...
                            <div class="mb-4">
                                ...
                                <select name="scrape_strategy" id="scrape_strategy"
                                    ...
                                    <option value="rss" {{ old('scrape_strategy', $affiliateSite->scrape_strategy) === 'rss' ? 'selected' : '' }}>RSS Feed</option>
                                    <option value="css" {{ old('scrape_strategy', $affiliateSite->scrape_strategy) === 'css' ? 'selected' : '' }}>CSS Selectors</option>
                                    <option value="xpath" {{ old('scrape_strategy', $affiliateSite->scrape_strategy) === 'xpath' ? 'selected' : '' }}>XPath Expressions</option>
                                    <option value="custom" {{ old('scrape_strategy', $affiliateSite->scrape_strategy) === 'custom' ? 'selected' : '' }}>Custom Scraper</option>
                                </select>
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" name="scrape_interval" id="scrape_interval" value="{{ old('scrape_interval', $affiliateSite->scrape_interval) }}" placeholder="e.g., daily, hourly, 6h, 30m"
                        ...
                        <div id="rss-config" class="mb-6 strategy-config hidden">
                            ...
                            <div class="mb-4">
                                ...
                                <input type="url" name="rss_feed_url" id="rss_feed_url" value="{{ old('rss_feed_url', $affiliateSite->rss_config['feed_url'] ?? '') }}" placeholder="https://example.com/feed.xml"
                        ...
                        <div id="css-config" class="mb-6 strategy-config hidden">
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" name="css_list_selector" id="css_list_selector" value="{{ old('css_list_selector', $affiliateSite->css_config['list_selector'] ?? '') }}" placeholder="e.g., .article-list, #posts"
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" name="css_item_selector" id="css_item_selector" value="{{ old('css_item_selector', $affiliateSite->css_config['item_selector'] ?? '') }}" placeholder="e.g., .article-item, .post"
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" name="css_title_selector" id="css_title_selector" value="{{ old('css_title_selector', $affiliateSite->css_config['title_selector'] ?? '') }}" placeholder="e.g., h2.title, .article-title"
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" name="css_url_selector" id="css_url_selector" value="{{ old('css_url_selector', $affiliateSite->css_config['url_selector'] ?? '') }}" placeholder="e.g., a.permalink, .article-link"
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" name="css_date_selector" id="css_date_selector" value="{{ old('css_date_selector', $affiliateSite->css_config['date_selector'] ?? '') }}" placeholder="e.g., time.published, .post-date"
                        ...
                        <div id="xpath-config" class="mb-6 strategy-config hidden">
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" name="xpath_list_expression" id="xpath_list_expression" value="{{ old('xpath_list_expression', $affiliateSite->xpath_config['list_expression'] ?? '') }}" placeholder="e.g., //div[@class='article-list']"
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" name="xpath_item_expression" id="xpath_item_expression" value="{{ old('xpath_item_expression', $affiliateSite->xpath_config['item_expression'] ?? '') }}" placeholder="e.g., //article"
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" name="xpath_title_expression" id="xpath_title_expression" value="{{ old('xpath_title_expression', $affiliateSite->xpath_config['title_expression'] ?? '') }}" placeholder="e.g., //h2[@class='title']/text()"
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" name="xpath_url_expression" id="xpath_url_expression" value="{{ old('xpath_url_expression', $affiliateSite->xpath_config['url_expression'] ?? '') }}" placeholder="e.g., //a[@class='permalink']/@href"
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" name="xpath_date_expression" id="xpath_date_expression" value="{{ old('xpath_date_expression', $affiliateSite->xpath_config['date_expression'] ?? '') }}" placeholder="e.g., //time/@datetime"
                        ...
                        <div id="custom-config" class="mb-6 strategy-config hidden">
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" name="custom_scraper_class" id="custom_scraper_class" value="{{ old('custom_scraper_class', $affiliateSite->custom_config['scraper_class'] ?? '') }}" placeholder="e.g., App\Scrapers\CustomSiteScraper"
                            ...
                            <div class="mb-4">
                                ...
                                <textarea name="custom_config_json" id="custom_config_json" rows="6" placeholder='{"key": "value"}'
                                          class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline font-mono text-sm @error('custom_config_json') border-red-500 @enderror">{{ old('custom_config_json', json_encode($affiliateSite->custom_config['options'] ?? [], JSON_PRETTY_PRINT)) }}</textarea>
                        ...
                        <div class="mb-6">
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" name="affiliate_program_id" id="affiliate_program_id" value="{{ old('affiliate_program_id', $affiliateSite->affiliate_program_id) }}" placeholder="e.g., amazon-associates-123"
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" name="affiliate_tracking_code" id="affiliate_tracking_code" value="{{ old('affiliate_tracking_code', $affiliateSite->affiliate_tracking_code) }}" placeholder="e.g., tag=yoursite-20"
